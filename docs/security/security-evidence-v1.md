...
| No obvious tracked credential was found                 | `PARTIALLY_VERIFIED` | Targeted redacted patterns against tracked tip and matching history commits                                                   | Only fixtures/placeholders were found; dedicated secret scanner was unavailable.                               |
...
| Portfolio claim: source-linked extraction                    | exact-source grounding and deterministic validation tests            | SEC-008: adversarial prompt-injection evidence missing                  |
