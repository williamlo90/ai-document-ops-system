...
This result measures the provider setup on one external licensed synthetic pack. It does not
establish production accuracy, customer value, or robustness across the invoice market.
...
and two valid sellers rejected. Two changes followed:
