...
| Document intake | New Document wizard | `/documents/upload-policy`, `/documents/upload`, `/documents/{id}/process` | Keep | Preserve persisted `document_type` and schema metadata |
