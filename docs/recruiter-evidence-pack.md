# Recruiter Project Tour

Start here for a quick review of the project. The links below show what works, how I tested it, and
...
I built an AI document workflow that reads invoices, validates the extracted data, keeps approval
with a human reviewer, controls export, and records enough detail to reproduce the evaluation.
