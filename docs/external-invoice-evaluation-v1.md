...
`extractor_http_error` after retries with fixed limits. The end-to-end holdout field accuracy is
...
The diagnostic split exposed and justified five targeted changes before the holdout:
