...
export function InboxPage() {
  ...
  const selectState = (value: 'needs-decision' | 'blocked') =>
  ...
  return (
    <div className="ops-page inbox-page">
      <PageHeader
        title="Inbox"
        description="Resolve the invoices that are waiting on a reviewer or blocked by validation."
      />
  ...
  if (!items.length)
    return (
      <EmptyState
        ...
        body="Invoices will appear here when validation finishes and a reviewer decision is required."
      />
    )
  return (
