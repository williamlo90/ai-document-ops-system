            ...
            <Panel className="invoice-library">
              ...
              {invoices.isLoading ? (
                ...
                <EmptyState
                  ...
                  body="Try clearing the current search or filters."
                />
              )}
              {invoices.data ? (
                <Pagination
                  page={invoices.data.page}
                  pages={invoices.data.total_pages}
...
function invoiceTabs(summary?: InvoiceListResponse['summary']) {
  return [
