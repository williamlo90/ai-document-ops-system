    ...
    <div className="ops-app">
      ...
      <aside className={`ops-sidebar ${mobileOpen ? 'is-open' : ''}`}>
        <div className="ops-brand">
          ...
          <div>
            ...
            <small>Review and approval</small>
          </div>
          <button
            type="button"
        ...
        <nav aria-label="Primary navigation">
          ...
          {items.some((item) => item.group === 'admin') ? (
            <>
              <span className="ops-nav-divider" />
              <span className="ops-nav-label">Admin</span>
            </>
          ) : null}
          {items
      ...
      <div className="ops-workspace">
        <header className="ops-topbar">
          ...
          <form className="ops-global-search" role="search" onSubmit={submitSearch}>
            <Search size={17} />
            <input
              value={search}
              onChange={(event) => setSearch(event.target.value)}
              aria-label="Search invoices, vendors, or invoice numbers"
            ...
            context={
              {
                ...
                refreshWorkspace: () => void workspace.refetch(),
