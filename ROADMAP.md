...
- Preserve API error boundaries: cross-workspace or missing resources should return generic 404, invalid request input should return 400, and not-ready backoffice actions should return generic 409.
