...
Backend for the AI-Powered Invoice Review & Approval System, an approval-gated invoice intake,
validation, correction, and export workflow.

The API supports local-first document intake, deterministic invoice validation, reviewer
decisions, audit evidence, controlled exports, and repeatable reliability evaluation. Some internal
